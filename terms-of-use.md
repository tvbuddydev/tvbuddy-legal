# Terms of Use
**TVBuddy: Smart TV Companion**  
Last updated: January 2026

## Acceptance of Terms
By downloading or using TVBuddy: Smart TV Companion (“TVBuddy”), you agree to these Terms of Use. If you do not agree, please do not use the app.

## App Purpose
TVBuddy is a utility application designed to interact with supported Smart TVs on the same local Wi-Fi network. Functionality may vary depending on TV model, operating system, and network configuration.

## No User Accounts
TVBuddy does not require user registration or account creation.

## User Responsibilities
You are responsible for:
- Ensuring you own or are authorized to control the connected TV
- Maintaining a compatible network environment
